...
public class PlanckProductionPlayer implements ComputerPlayer {
    ...
    private Point findSpotForWoodcutterNextToForesterHut(ForesterHut foresterHut) throws Exception {
        ...
        List<Point> spots = Utils.findAvailableHousePointsWithinRadius(map, player, foresterHut.getPosition(), SMALL);
    ...
    private Point findSpotForSawmill(Headquarter headquarter) throws Exception {
        ...
        /* Find available spots close to the forester */
        List<Point> spots = Utils.findAvailableHousePointsWithinRadius(map, player, headquarter.getPosition(), MEDIUM);

...
public class TestAttackPlayer {
    ...
    public void testAttackerWithBuildingInReachAttacks() throws Exception {
        ...
        Barracks barracks0 = MoreUtils.placeAndOccupyBarracks(map, player0, point2);

        /* Place and occupy barracks for player 1 */
        Point point3 = new Point(34, 10);
        Barracks barracks1 = MoreUtils.placeAndOccupyBarracks(map, player1, point3);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            List<Military> militariesOutside = Utils.findWorkersOfTypeOutsideForPlayer(Military.class, player0, map);
        ...
        List<Military> militaries = Utils.findWorkersOfTypeOutsideForPlayer(Military.class, player0, map);
